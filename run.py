...
{GREEN}    ━━━━━━━━━━━━━━━━━━━━━
{GREEN}━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━
\033[1;32m│\033[1;32m☞  \033[1;32m𝐀𝐔𝐓𝐇𝐎𝐑     \033[1;97m➟   \033[1;32mRYDAHXYBER     \033[1;31m
\033[1;32m│\033[1;32m☞  \033[1;32m𝐅𝐀𝐂𝐄𝐁𝐎𝐎𝐊   \033[1;97m➟   \033[1;32mANONYMOUS\033[1;31m     
\033[1;32m│\033[1;32m☞  \033[1;32m𝐆𝐈𝐓𝐇𝐔𝐁    \033[1;97m ➟   \033[1;32mRYDAH06             \033[1;31m
\033[1;32m│\033[1;32m☞  \033[1;32m𝐖𝐇𝐀𝐓𝐒𝐀𝐏𝐏  \033[1;97m ➟   \033[1;32m+2349017624430             \033[1;31m
\033[1;32m│\033[1;32m☞  \033[1;32m𝐕𝐄𝐑𝐒𝐈𝐎𝐍   \033[1;97m ➟   \033[1;32m0.1                     \033[1;31m
\033[1;32m│\033[1;32m☞  \033[1;32m𝐘𝐎𝐔𝐓𝐔𝐁𝐄   \033[1;97m ➟   \033[1;32mRYDAH TECH             \033[1;31m
\033[1;32m==========================================================
\033[37;44m    DONT THINK YOURE HACKER BY USING READYMADE TOOLS     \033[0;m
\033[1;32m=========================================================="""
...
def password1():
    ...
    print(f"")
    print(f"{GREEN}══════════════════════════════════════════════════════")
    print(f"{WHITE}MTN Number :")
    print(f"{GREEN}   234810 ,234813 ,234814 ,234816 ,234703 ,234706 ,234903 , 234906 ,234803 ,234806")
    print(f"{GREEN}══════════════════════════════════════════════════════")
    print(f" 9mobile/Etisalat Number :")
    print(f"{WHITE}   234809 ,234817 ,234818 ,234908 ,234909")
    print(f"{GREEN}══════════════════════════════════════════════════════")
    print(f" Airtel Number :")
    print(f"{WHITE}   234802 ,234808 ,234812 ,234708 ,234701 ,234902 ,234901 ,234907")
    print(f"{GREEN}══════════════════════════════════════════════════════")
    print(f" Glo Number :")
    print(f"{WHITE}   234805 ,234807 ,234811 ,234815 ,234705 ,234905")
    print(f"{GREEN}══════════════════════════════════════════════════════")
    print(f" INTEL Number :")
    print(f"{WHITE}   234804")
    print(f"{GREEN}══════════════════════════════════════════════════════")
    print(f" Smile Number :")
    print(f"{WHITE}   234702")
    print(f"{GREEN}══════════════════════════════════════════════════════")
    print(f" Multilinks Number :")
    print(f"{WHITE}   234709")
    print(f"")
    linex()
    ...
    with ThreadPool(max_workers=30) as manshera:    
        clear()
        tl = str(len(user))
        print(f" {GREEN}TOTAL IDZ             : {WHITE}"+tl+" ~> [ FASTEST⚡]")
...
def password2():
    ...
    with ThreadPool(max_workers=30) as manshera:    
        clear()
        tl = str(len(user))
        print(f" {GREEN}TOTAL IDZ             : {WHITE}"+tl+" ~> [ FAST ]")
        print(f" {GREEN}COUNTRY YOU CHOOSE    : {WHITE}NIGERIA NG")
        print(f" {GREEN}NUMBER YOU PUT        : {WHITE}"+code)
        print(f" {GREEN}TODAY DATE & TIME     :{GREEN} {ha}/{bu}/{ta} {WHITE}~> {GREEN} "+str(a)+":"+str(lt()[4])+" "+ tag+" ")
        print(f" {GREEN}THE PROCESS HAS BEEN STARTED ")
...
def password5():
    ...
    print(f"")
    linex()
    print(f"\x1b[97m[\033[37;41mRSCT NIG BASED TOOLS   \033[0;m]")
    print(f"{GREEN}══════════════════════════════════════════════════════")
    print("")
    linex()
    code = input(' PUT CODE : ')
...
def Tabii2():
    ...
    with ThreadPool(max_workers=30) as manshera:    
        clear()
        tl = str(len(user))
        print(f"\n {GREEN}TOTAL IDZ             : {RED}"+tl)
        print(f" {GREEN}COUNTRY YOU CHOOSE    : {RED}NIGERIA NG")
        print(f" {GREEN}NUMBER YOU PUT        : {RED}"+code)
        print(f" {GREEN}PROCESS HAS BEEN STARTED")
        print(f" {GREEN}BE PATIENT.......")
        print(f" {GREEN}THE PROCCESS HAS BEEN STARTED ")
        print(f'{RED}==========================================================')
        for love in user:
            uid = code+love
